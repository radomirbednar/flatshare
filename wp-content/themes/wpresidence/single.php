...
<div id="post" <?php post_class('row'); ?>>
    ...
    <div class=" <?php print $options['content_class']; ?> ">
        ...
        while (have_posts()) : the_post();
            ...
            <div class="meta-info"> 
                <div class="meta-element"> <?php _e('Posted by ', 'wpestate');
            print ' ' . get_the_author() . ' ';
            _e('on', 'wpestate');
            print' ' . the_date('', '', '', FALSE); ?></div>
                <div class="meta-element"> <?php print '<span class="meta-separator"> | </span><i class="fa fa-file-o"></i> ';
            the_category(', ') ?></div>
                <div class="meta-element"> <?php print '<span class="meta-separator"> | </span><i class="fa fa-comment-o"></i> ';
            comments_number('0', '1'); ?>   </div>   
