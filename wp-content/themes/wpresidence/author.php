    ...
    <div class="col-md-9 rightmargin"> 
        ...
        <div id="content_container">  
            ...
            $activity_array = array(
                '1' => array(
                    '<i class="icon-icon_student"> </i>',
                    __('Student', 'wpestate'))
                ,
                '2' => array(
                    '<i class="icon-icon_professional"> </i>',
                    __('Professional', 'wpestate')
                )
            );
            ...
            $how_long_array = array(
                '1' => array(
                    '<i class="icon-icon_shortterm"> </i>',
                    __('short term', 'wpestate'))
                ,
                '2' => array(
                    '<i class=" icon-icon_longterm"> </i>',
                    __('long term', 'wpestate')
            ));
            ...
            $smoker_array = array(
                '1' => array(
                    '<i class="icon-icon_no-smoking"> </i>',
...
<?php if ($user_status != 3): ?>  
    ...
    if ($activity != '') {
        print $activity_array[$activity][0] . $activity_array[$activity][1];
    }
    ?>
            </div>  
            <div class="sub_block"> 
    ...
    ?>     
        ...
        <?php print $how_long_array[$how_long][0] . $how_long_array[$how_long][1]; ?>
                </div> 
                <?php endif; ?>
    ...
    <?php print $sexual_preference_array[$sexual_preference][0] . $sexual_preference_array[$sexual_preference][1]; ?>  
            ...
            <div class="sub_block">         
                <span class="sub"><?php print __('Bed time: ', 'wpestate'); ?></span>
    <?php print $sleeping_span_array[$sleeping_span][0] . $sleeping_span_array[$sleeping_span][1]; ?> 
            </div>

            <div class="sub_block">
                <span class="sub"><?php print __('Relationship: ', 'wpestate'); ?></span>   
