...
if( !function_exists('wpestate_show_search_field_classic_form') ):
    function  wpestate_show_search_field_classic_form($postion,$action_select_list,$categ_select_list ,$select_city_list,$select_area_list){
        ...
        $return_string .= '<input type="text" id="adv_location" class="form-control" name="adv_location" placeholder="'. __('City', 'wpestate') . '" value="' . (isset($_GET['adv_location']) ? esc_attr($_GET['adv_location']) : '') . '" autocomplete="off" data-value="all">';
        $return_string .= '</div>';        
//$return_string .= '</div>';
