...
if (!function_exists('wpestate_direct_pay_pack_per_listing')):
    ...
    function wpestate_direct_pay_pack_per_listing() {
        ...
        if (function_exists('icl_translate')) {
            ...
            $payment_details = icl_translate('wpestate', 'wp_estate_property_copyright_text', $mes);
        } else {
...
if (!function_exists('wpestate_ajax_register_user')):
    ...
    function wpestate_ajax_register_user() {
        ...
        if ($enable_user_pass_status == 'yes') {
            $user_pass = trim(wp_kses($_POST['user_pass'], $allowed_html));
            $user_pass_retype = trim(wp_kses($_POST['user_pass_retype'], $allowed_html));
...
if (!function_exists('wpestate_ajax_update_profile')):
    ...
    function wpestate_ajax_update_profile() {
         ...
         * Update user integer values
          ...
          if(!empty($data[$key])){
          update_user_meta_int($userID, $key, $data[$key]);
          }
          else {
         ...
         */
        fl_update_user_language($userID, empty($data['language']) ? array() : $data['language']);
