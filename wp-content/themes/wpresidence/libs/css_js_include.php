...
if (!function_exists('wpestate_scripts')):
    ...
    function wpestate_scripts() {
        ...
        wp_enqueue_script('jquery.encoders', get_template_directory_uri() . '/js/encoder.js', array('jquery'), '1.0', true);
        wp_enqueue_script('jquery.chart.min', get_template_directory_uri() . '/js/Chart.min.js', array('jquery'), '1.0', true);
        
        wp_enqueue_script('mob-script', get_template_directory_uri() . '/js/jquery_mob.js', array('jquery'), '1.0', true);
...
//  wp_enqueue_script('jquery.retina', get_template_directory_uri().'/js/retina-1.1.0.js',array('jquery'), '1.0', true);
        ...
        if (get_post_type() === 'estate_property' && !is_tax() && !is_search()) {
            ...
            wp_localize_script('googlecode_property', 'googlecode_property_vars', array('general_latitude' => esc_html(get_option('wp_estate_general_latitude', '')),
            ...
            if ($custom_image == '') {
                ...
                wp_localize_script('googlecode_contact', 'googlecode_contact_vars', array('hq_latitude' => $hq_latitude,
            ...
            if ($header_type == 5 || $global_header_type == 4 || is_page_template('advanced_search_results.php')) {
                ...
                wp_localize_script('googlecode_regular', 'googlecode_regular_vars', array('general_latitude' => $page_lat,
        ...
        if ($load_extra == 1) {
            ...
            wp_localize_script('mapfunctions', 'mapfunctions_vars', array('path' => get_template_directory_uri() . '/css/css-images',
        ...
        if (is_page_template('user_dashboard_add.php') || is_page_template('user-dashboard.php')) {
            ...
            wp_localize_script('google_map_submit', 'google_map_submit_vars', array('general_latitude' => $page_lat,
                'general_longitude' => $page_long,
        ...
        if (function_exists('icl_translate')) {
            ...
            $direct_payment_details = icl_translate('wpestate', 'wp_estate_property_copyright_text', $mes);
        } else {
            $direct_payment_details = wp_kses(get_option('wp_estate_direct_payment_details', ''), $argsx);
        }
        ...
        if (is_singular('estate_property')) {
            ...
            wp_enqueue_script('wpestate_property', get_template_directory_uri() . '/js/property.js', array('jquery'), '1.0', true);
            wp_localize_script('wpestate_property', 'wpestate_property_vars', array('singular_label' => json_encode($array_label),
        ...
        wp_localize_script('control', 'control_vars', array('morg1' => __('Amount Financed:', 'wpestate'),
        ...
        wp_localize_script('ajaxcalls', 'ajaxcalls_vars', array('contact_name' => __('Your Name', 'wpestate'),
            'contact_email' => __('Your Email', 'wpestate'),
            'contact_phone' => __('Your Phone', 'wpestate'),
            'contact_comment' => __('Your Message', 'wpestate'),
            'adv_contact_name' => __('Your Name', 'wpestate'),
        ...
        if (is_page_template('user_dashboard_profile.php') || is_page_template('user_dashboard_add.php')) {
            ...
            wp_localize_script('ajax-upload', 'ajax_vars', array('ajaxurl' => admin_url('admin-ajax.php'),
...
if (!function_exists('wpestate_admin')):
    ...
    function wpestate_admin($hook_suffix) {
        ...
        wp_localize_script('admin-control', 'admin_control_vars', array('ajaxurl' => admin_url('admin-ajax.php'),
            'plan_title' => __('Plan Title', 'wpestate'),
            'plan_image' => __('Plan Image', 'wpestate'),
            'plan_desc' => __('Plan Description', 'wpestate'),
            'plan_size' => __('Plan Size', 'wpestate'),
        ...
        wp_localize_script('admin-control', 'ajax_vars', array(
        ...
        if (is_admin() && ( $pagenow == 'post-new.php' || $pagenow == 'post.php') && $typenow == 'estate_property' || is_page_template('advanced_search_results.php')) {
            if (esc_html(get_option('wp_estate_ssl_map', '')) == 'yes') {
                ...
                wp_enqueue_script('googlemap', 'http://maps.googleapis.com/maps/api/js?sensor=true', array('jquery'), '1.0', false);
            }
            ...
            wp_localize_script('admin_google', 'admin_google_vars', array('general_latitude' => $wp_estate_general_latitude,
