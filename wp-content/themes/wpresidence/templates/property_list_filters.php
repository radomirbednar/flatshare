...
?>
    ...
    <div class="listing_filters_head"> 
        <input type="hidden" id="page_idx" value="<?php 
          ...
          //  if( !empty($tax_terms) ){ ?>
                <div class="dropdown listing_filter_select" >
                  <div data-toggle="dropdown" id="a_filter_action" class="filter_menu_trigger" data-value="<?php print $current_adv_filter_search_meta;?>"> <?php print $current_adv_filter_search_label;?> <span class="caret caret_filter"></span> </div>           
        ...
        //    }
          ...
          //   if( !empty($categories) ){ ?>
                <div class="dropdown listing_filter_select" >
                  <div data-toggle="dropdown" id="a_filter_categ" class="filter_menu_trigger" data-value="<?php print $current_adv_filter_category_meta;?>"> <?php print $current_adv_filter_category_label;?> <span class="caret caret_filter"></span> </div>           
        ...
        //     }
             ?>
                ...
                <div class="dropdown listing_filter_select" >
                  <div data-toggle="dropdown" id="a_filter_cities" class="filter_menu_trigger" data-value="<?php print $current_adv_filter_city_meta;?>"> <?php print $current_adv_filter_city_label;?> <span class="caret caret_filter"></span> </div>           
                ...
                <div class="dropdown listing_filter_select" >
                  <div data-toggle="dropdown" id="a_filter_areas" class="filter_menu_trigger" data-value="<?php print $current_adv_filter_area_meta;?>"><?php print $current_adv_filter_area_label;?><span class="caret caret_filter"></span> </div>           
    ...
    <?php }else{
    ?>
        <div data-toggle="dropdown" id="a_filter_action" class="" data-value="<?php print $current_adv_filter_search_meta;?>"></div>           
        <div data-toggle="dropdown" id="a_filter_categ" class="" data-value="<?php print $current_adv_filter_category_meta;?>"></div>           
        <div data-toggle="dropdown" id="a_filter_cities" class="" data-value="<?php print $current_adv_filter_city_meta;?>"></div>           
        <div data-toggle="dropdown" id="a_filter_areas" class="" data-value="<?php print $current_adv_filter_area_meta;?>"></div>           
        <div data-toggle="dropdown" id="a_filter_county" class="" data-value="<?php print $current_adv_filter_county_meta;?>"></div>           
