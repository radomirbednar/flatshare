            ...
            <div class="half_form">  
                <div class="switcher fl-row"> 
                    ...
                    <div class="value-row">
                        ...
                        <input id="how_long-3" name="how_long" type="radio" value="3" class="hidden" <?php echo empty($how_long) || 3 == $how_long ? ' checked="checked" ' : '' ?>>      
                        <label for="how_long-3" class="wpb_button wpb_btn-large <?php echo empty($how_long) || 3 == $how_long ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label>  
                        <label for="how_long-1" class="wpb_button wpb_btn-large <?php echo isset($how_long) && 1 == $how_long ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Short term', 'wpestate'); ?></label>
            ...
            <div class="half_form">   
                <div class="switcher fl-row"> 
                    ...
                    <div class="value-row">                
                        ...
                        <input id="sexual_preference-3" name="sexual_preference" type="radio" value="3" class="hidden" <?php echo empty($sexual_preference) || 3 == $sexual_preference ? ' checked="checked" ' : '' ?>> 
                        <label for="sexual_preference-3" class="wpb_button wpb_btn-large <?php echo empty($sexual_preference) || 3 == $sexual_preference ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label>
            ...
            <div class="half_form">   
                <div class="switcher fl-row">                        
                    ...
                    <div class="value-row">
                        ...
                        <label for="user_gender-3" class="wpb_button wpb_btn-large <?php echo empty($user_gender) || 3 == $user_gender ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label>     
            ...
            <div class="half_form"> 
                <div class="switcher fl-row">
                    ...
                    <div class="value-row">
                        ...
                        <input id="sleeping_span-3" name="sleeping_span" type="radio" value="3" class="hidden" <?php echo empty($sleeping_span) || 3 == $sleeping_span ? ' checked="checked" ' : '' ?>> 
                        <label for="sleeping_span-3" class="wpb_button wpb_btn-large <?php echo empty($sleeping_span) || 3 == $sleeping_span ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
            ...
            <div class="half_form"> 
                <div class="switcher fl-row">
                    ...
                    <div class="value-row">
                        ...
                        <input id="couple-3" name="couple" type="radio" value="3" class="hidden" <?php echo empty($couple) || 3 == $couple ? ' checked="checked" ' : '' ?>> 
                        <label for="couple-3" class="wpb_button wpb_btn-large <?php echo empty($couple) || 3 == $couple ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
                        <label for="couple-1" class="wpb_button wpb_btn-large <?php echo isset($couple) && 1 == $couple ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Single', 'wpestate'); ?></label>
            ...
            <div class="half_form"> 
                <div class="switcher fl-row">
                    ...
                    <div class="value-row">
                        ...
                        <input id="pets-3" name="pets" type="radio" value="3" class="hidden" <?php echo empty($pets) || 3 == $pets ? ' checked="checked" ' : '' ?>> 
                        <label for="pets-3" class="wpb_button wpb_btn-large <?php echo empty($pets) || 3 == $pets ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
            ...
            <div class="half_form">      
                <div class="switcher fl-row">                    
                    ...
                    <div class="value-row">
                        ...
                        <input id="smoker-3" name="smoker" type="radio" value="3" class="hidden" <?php echo empty($smoker) || 3 == $smoker ? ' checked="checked" ' : '' ?>>                         
                        <label for="smoker-3" class="wpb_button wpb_btn-large <?php echo empty($smoker) || 3 == $smoker ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
            ...
            <div class="half_form">
                <div class="switcher fl-row">                    
                    ...
                    <div class="value-row">
                        ...
                        <input id="party-3" name="party" type="radio" value="3" class="hidden" <?php echo empty($party) || 3 == $party ? ' checked="checked" ' : '' ?>> 
                        <label for="party-3" class="wpb_button wpb_btn-large <?php echo empty($party) || 3 == $party ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
            ...
            <div class="half_form">
                <div class="switcher fl-row">
                    ...
                    <div class="value-row">
                        ...
                        <input id="activity-3" name="activity" type="radio" value="3" class="hidden" <?php echo empty($activity) || 3 == $activity ? ' checked="checked" ' : '' ?>> 
                        <label for="activity-3" class="wpb_button wpb_btn-large <?php echo empty($activity) || 3 == $activity ? 'wpb_btn-on' : 'wpb_btn-off' ?>"><?php _e('Never mind', 'wpestate'); ?></label> 
