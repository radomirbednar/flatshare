...
<div data-toggle="dropdown" id="second_filter_action" class="hide" data-value="<?php print $current_adv_filter_search_meta;?>"> <?php print $current_adv_filter_search_label;?>  </div>           
<div data-toggle="dropdown" id="second_filter_categ" class="hide" data-value="<?php print $current_adv_filter_category_meta;?> "> <?php print $current_adv_filter_category_label;?> </div>           
<div data-toggle="dropdown" id="second_filter_cities" class="hide" data-value="<?php print $current_adv_filter_city_meta;?>"> <?php print $current_adv_filter_city_label;?>  </div>           
<div data-toggle="dropdown" id="second_filter_areas"  class="hide" data-value="<?php print $current_adv_filter_area_meta;?>"><?php print $current_adv_filter_area_label;?></div>           
<div data-toggle="dropdown" id="second_filter_county"  class="hide" data-value="<?php print $current_adv_filter_county_meta;?>"><?php print $current_adv_filter_county_label;?></div>           
