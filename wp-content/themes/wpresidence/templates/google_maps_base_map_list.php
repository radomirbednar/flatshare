<div id="gmap-control-list">
    <span  id="gmapzoomplus-list"><i class="fa fa-plus"></i></span>
    <span  id="gmapzoomminus-list"><i class="fa fa-minus"></i></span>
    
    <span  id="map-view"><i class="fa fa-picture-o"></i><?php _e('View','wpestate');?></span>
        <span id="map-view-roadmap"     accesskey=""class="map-type"><?php _e('Roadmap','wpestate');?></span>
