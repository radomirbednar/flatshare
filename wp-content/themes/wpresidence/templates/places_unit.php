...
<div class="<?php echo $col_class;?> listing_wrapper" data-org="<?php echo $col_org;?>" data-listid="<?php echo $post->ID;?>" > 
    <div class="property_listing places_listing" data-link="<?php echo $term_link;?>" >
        ...
        <div class="listing_details the_grid_view"><?php  echo wpestate_strip_words( $category_description,20).' ...';?></div>
        
        <div class="listing_unit_price_wrapper">
            <?php echo $category_count.' '.__('Listings','wpestate' )?>                    
            <div class="listing_actions">
                               
                    <div class="share_unit">
                        <a href="http://www.facebook.com/sharer.php?u=<?php echo $term_link; ?>&amp;t=<?php echo urlencode($category_name); ?>" target="_blank" class="social_facebook"></a>
                        <a href="http://twitter.com/home?status=<?php echo urlencode($category_name.' '.$term_link); ?>" class="social_tweet" target="_blank"></a>
                        <a href="https://plus.google.com/share?url=<?php echo $term_link; ?>" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank" class="social_google"></a> 
                        <a href="http://pinterest.com/pin/create/button/?url=<?php echo $term_link; ?>&amp;media=<?php if (isset( $category_featured_image_url)){ echo $category_featured_image_url; }?>&amp;description=<?php echo urlencode($category_name); ?>" target="_blank" class="social_pinterest"></a>
                    </div>
