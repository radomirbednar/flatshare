...
<div class="<?php echo $col_class;?> listing_wrapper" data-org="<?php echo $col_org;?>" data-listid="<?php echo $post->ID;?>" > 
    <div class="property_listing" data-link="<?php   if(  $property_unit_slider==0){ echo $link;}?>">
        <?php
        ...
        if ( has_post_thumbnail() ):
           ...
           $measure_sys            = esc_html ( get_option('wp_estate_measure_sys','') ); 
            ...
            if(  $property_unit_slider==1){
                ...
                print '
                <div id="property_unit_carousel_'.$post->ID.'" class="carousel property_unit_carousel slide  " data-ride="carousel" data-interval="false">
                    ...
                    if( $no_slides>1){
                        print '<a class="left  carousel-control" href="#property_unit_carousel_'.$post->ID.'" data-slide="prev">
                            <i class="fa fa-angle-left"></i>
                        </a>

                        <a class="right  carousel-control" href="#property_unit_carousel_'.$post->ID.'" data-slide="next">
        ...
        <?php if ($align_class=='the_list_view') {?>
            <div class="listing_details the_list_view" style="display:block;">
               <?php    echo wpestate_strip_words( get_the_excerpt(),16).' ...'; ?>
            </div>   
