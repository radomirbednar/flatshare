<div class="header-image"> 
    <div class="homepage-hero-module">
        <div>
            ...
            <h1 class="heading_title">Find your flatshare</h1>
            <video id="video" loop>
                ...
                <source src="<?php echo get_template_directory_uri() ?>/video/meetingroom/WEBM/Meeting_Room.ogv" type="video/ogg" />Your browser does not support the video tag. I suggest you upgrade your browser.
            </video> 
            <script> 
