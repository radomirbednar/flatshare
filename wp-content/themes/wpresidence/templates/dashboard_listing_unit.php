   ...
   <div class="blog_listing_image">
    ...
    <div class="prop-info">
        ...
        <div class="info-container">
            ...
            <a  data-original-title="<?php _e('Floor Plans','wpestate');?>"   class="dashboad-tooltip" href="<?php  print $floor_link;?>"><i class="fa  fa-book editprop"></i></a>
            <a  data-original-title="<?php _e('Views Stats','wpestate');?>"   class="dashboad-tooltip show_stats"  data-listingid="<?php echo $post_id;?>" href="#"><i class="fa fa-eye-slash "></i></a>
        ...
        <div class="payment-container <?php echo $no_payment; ?>">
    ...
    <div class="statistics_wrapper">
        <div class="statistics_wrapper_total_views">
            <?php _e('Total number of views:','wpestate'); echo intval( get_post_meta($post_id, 'wpestate_total_views', true)); ?>
        </div>
        <canvas class="my_chart_dash" id="myChart_<?php echo $post_id;?>"></canvas>
    </div>   
 </div>