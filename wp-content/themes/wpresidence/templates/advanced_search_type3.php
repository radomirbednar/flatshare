...
<div class="adv-search-3 <?php echo $close_class.' '.$extended_class;?>" id="adv-search-3" data-postid="<?php echo $post_id; ?>"> 
    ...
    <form role="search" method="get"   action="<?php print $adv_submit; ?>" >
        ...
        <input name="submit" type="submit" class="wpb_button  wpb_btn-info wpb_btn-large" id="advanced_submit_3" value="<?php _e('SEARCH PROPERTIES','wpestate');?>">
